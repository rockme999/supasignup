 ...
 * v2.5.1 (2026-05-02): 위젯 디자인 카드 3개 accordion + 위젯 안내 텍스트1·2 + 쿠폰팩 위젯 직접 노출 + 가입 후 원래 페이지 복귀 + AI 카피 widgetText1/2
 * 신기능 추가 시마다 이 상수를 갱신해 사이드 메뉴 NEW 배지가 다시 표시되도록 함.
 */
export const LATEST_PLUS_PRESET_ADDED = '2026-05-02T04:00:00Z';
